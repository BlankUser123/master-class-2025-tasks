...
public class Field implements GLEventListener {
    ...
    private BlenderObj model = BlenderObjReader.read("blender_models/thorus/thorus.obj",
            "blender_models/thorus/thorus.mtl", false);
    ...
    private void setShaderData(GL2 gl) {
        ...
        if (program != -1) {
            ...
            gl.glUniform3f(ShaderUtils.getUniLoc(gl, program, "Light.La"), 1.0f, 1.0f, 1.0f);
            gl.glUniform3f(ShaderUtils.getUniLoc(gl, program, "Light.Ld"), 1.0f, 1.0f, 1.0f);
            gl.glUniform3f(ShaderUtils.getUniLoc(gl, program, "Light.Ls"), 1.0f, 1.0f, 1.0f);

            //инициализация матриц
            //матрица модели-вида
            mvMatrix.translate(0.0f, 0.0f, -4f);
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        mvMatrix.rotate(rotY, 0.0f, 1.0f, 0f);
        gl.glUniformMatrix4fv(ShaderUtils.getUniLoc(gl, program, "ModelViewMatrix"), 1, false,
                FloatBuffer.wrap(mvMatrix.getMatrix()));
